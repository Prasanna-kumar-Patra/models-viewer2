var ModelViewer = function () {
  ...
  self.createNavigation = function () {
    ...
    for (var i = 0; i < titles.length; i++) {
      htmlStr +=
        '<label class="pagination-title labelTitle" id="label_' +
        i +
        '">' +
    ...
    htmlStr +=
      '<button class="pagination-btn arrow arrow-left prev"><span class="material-icons arrow">arrow_left</span></button>';
    htmlStr +=
      '<button class="pagination-btn arrow arrow-right next" ><span class="material-icons arrow">arrow_right</span></button>';
    ...
    if (isAutoplay === false) {
      $(".navBtn").html(
        '<span class=" material-symbols-outlined isAutoplay">autoplay</span>'
      );
    } else {
  ...
  self.createNavPopup = function () {
    ...
    htmlStr +=
      '<span class="colorDiv" id="black"></span><span class="colorDiv" id="gray"></span><span class="colorDiv" id="coral"></span><span class="colorDiv" id="fuchsia"></span>';
    ...
    for (var i = 0; i < titles.length; i++) {
      ...
      htmlStr +=
        '<li class="link list-item" id="link_' +
        i +
        '"><span class="index">' +
        (i + 1) +
        "</span> " +
  ...
  self.createDescriptionBox = function (ctr) {
    ...
    htmlStr +=
      '<p class="descriptionText" id="description_' +
      ctr +
      '">' +
      descriptions[ctr].textContent +
      "</p>";
    // htmlStr += '</div>'
  ...
  self.annotationClicked = (annotation, callee) => {
    console.log(
      "pkp:  ~ file: index.html:142 ~ annotationClicked ~ callee",
      annotation
    );
